 ...
 */
export async function pipelineContinue(userId, projectId, feedback, workspaceRoot) {
    try {
        ...
        if (feedback.toLowerCase().trim() === 'agree') {
            ...
            const result = await executeUntilCheckpoint(finalWorkspaceRoot, userId, projectId, state.template_name, true // 跳过第一个阶段（已推进过了）
            );
...
//# sourceMappingURL=pipeline-continue.js.map