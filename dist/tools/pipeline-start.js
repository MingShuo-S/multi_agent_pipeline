 ...
 */
export async function executeUntilCheckpoint(workspaceRoot, userId, projectId, templateName, skipFirstStage = false) {
    try {
 ...
 * 检查 state.json 是否已存在
 */
async function stateExists_check(stateManager) {
    try {
 ...
 * pipeline_start 实现
 */
export async function pipelineStart(templateName, userId, projectId, workspaceRoot) {
    return executeUntilCheckpoint(workspaceRoot || DEFAULT_WORKSPACE_ROOT, userId, projectId, templateName, false);
}
//# sourceMappingURL=pipeline-start.js.map